<?php
/**
 * Шаблон письма клиенту о заказе в обработке
 * Переопределяет стандартный шаблон WooCommerce для отображения информации о доставке СДЭК
 * 
 * Этот файл должен быть размещен в: hello-elementor/woocommerce/emails/customer-processing-order.php
 * 
...
<p><?php esc_html_e( 'Спасибо за ваш заказ. Он был получен и сейчас обрабатывается. Детали вашего заказа приведены ниже для справки:', 'woocommerce' ); ?></p>
...
if ($is_cdek_order && $delivery_type) {
    ...
    <div style="background: #f8f9fa; border: 2px solid #007cba; border-radius: 8px; padding: 20px; margin: 20px 0;">
        <h2 style="color: #007cba; margin-top: 0; text-align: center;">🚚 Информация о получении заказа</h2>
        ...
        <?php switch ($delivery_type) {
            case 'pickup': ?>
                <div style="background: #d4edda; border: 1px solid #c3e6cb; padding: 15px; border-radius: 6px;">
                    ...
                    <div style="background: #fff3cd; border: 1px solid #ffeaa7; padding: 10px; border-radius: 4px; margin-top: 10px;">
                        <p style="margin: 0; color: #856404;"><strong>📞 Важно:</strong> Пожалуйста, свяжитесь с нами для уточнения времени получения заказа.</p>
                    </div>
                </div>
                <?php break;
            ...
            case 'manager': ?>
                <div style="background: #d1ecf1; border: 1px solid #bee5eb; padding: 15px; border-radius: 6px;">
                    ...
                    <p>Вы выбрали доставку по договоренности с менеджером.</p>
                    <p><strong>Стоимость:</strong> Бесплатно</p>
                    <div style="background: #d1ecf1; border: 1px solid #bee5eb; padding: 10px; border-radius: 4px; margin-top: 10px;">
                        <p style="margin: 0; color: #0c5460;"><strong>📋 Информация:</strong> Наш менеджер свяжется с вами в ближайшее время для уточнения деталей доставки.</p>
                    </div>
                </div>
                <?php break;
                ...
                if ($point_code && $point_data) { ?>
                    <div style="background: #e3f2fd; border: 1px solid #2196f3; padding: 15px; border-radius: 6px;">
                        ...
                        <div style="background: white; padding: 15px; border-radius: 4px; border: 1px solid #e1e5e9;">
                            ...
                            <div style="background: #e8f5e8; border: 1px solid #c3e6cb; padding: 10px; border-radius: 4px; margin-top: 10px;">
                                <p style="margin: 0; color: #155724;"><strong>💡 Совет:</strong> При получении заказа не забудьте взять с собой документ, удостоверяющий личность.</p>
                            </div>
                        </div>
                    </div>
                <?php } else { ?>
